...
The goal of bandicoot is to provide tools for building light-weight python-like object oriented system. This system is inspired by the OOP systems implemented in [R6](https://github.com/r-lib/R6) and [Python](https://github.com/python/cpython).
